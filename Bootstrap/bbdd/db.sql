...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-10-2024 a las 12:17:48
...
--
-- Base de datos: `basedatoscrespan`
--
CREATE DATABASE IF NOT EXISTS `basedatoscrespan` DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci;
USE `basedatoscrespan`;
...
INSERT INTO `menu_items` (`id`, `titulo`, `url`, `nivel`, `padre_id`, `orden`, `es_dropdown`, `controlador`, `metodo`) VALUES
(1, 'Home', '#', 1, NULL, 1, 0, NULL, NULL),
(2, 'Features', '#', 1, NULL, 2, 0, NULL, NULL),
(3, 'Pricing', '#', 1, NULL, 3, 0, NULL, NULL),
(4, 'Dropdown link', '#', 1, NULL, 4, 1, NULL, NULL),
(5, 'Usuario', '#', 2, 4, 1, 0, 'Usuarios', 'getVistaFiltros'),
(6, 'Login', 'login.php', 2, 4, 2, 0, NULL, NULL),
(7, 'Menu', '#', 2, 4, 3, 0, 'Menu', 'getVistaMenuVertical');
...
--
ALTER TABLE `menu_items`
  ADD CONSTRAINT `menu_items_ibfk_1` FOREIGN KEY (`padre_id`) REFERENCES `menu_items` (`id`);
COMMIT;
